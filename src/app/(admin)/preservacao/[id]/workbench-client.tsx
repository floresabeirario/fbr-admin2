...
const STATUS_COLORS: Record<string, string> = {
  ...
  entrega_agendada:       "bg-orange-50 text-orange-600 border-orange-200",
  flores_enviadas:        "bg-amber-50 text-amber-700 border-amber-200",
  flores_recebidas:       "bg-yellow-50 text-yellow-700 border-yellow-200",
  flores_na_prensa:       "bg-lime-50 text-lime-700 border-lime-200",
  reconstrucao_botanica:  "bg-green-50 text-green-600 border-green-200",
  a_compor_design:        "bg-emerald-50 text-emerald-600 border-emerald-200",
  a_aguardar_aprovacao:   "bg-teal-50 text-teal-600 border-teal-200",
  a_ser_emoldurado:       "bg-cyan-50 text-cyan-600 border-cyan-200",
  emoldurado:             "bg-sky-50 text-sky-600 border-sky-200",
  a_ser_fotografado:      "bg-blue-50 text-blue-600 border-blue-200",
  quadro_pronto:          "bg-indigo-50 text-indigo-600 border-indigo-200",
  quadro_enviado:         "bg-violet-50 text-violet-600 border-violet-200",
  quadro_recebido:        "bg-fuchsia-50 text-fuchsia-600 border-fuchsia-200",
...
const STATUS_ITEM_COLORS: Record<keyof typeof STATUS_LABELS, string> = {
  ...
  entrega_agendada:       "text-orange-600",
  flores_enviadas:        "text-amber-700",
  flores_recebidas:       "text-yellow-700",
  flores_na_prensa:       "text-lime-700",
  reconstrucao_botanica:  "text-green-600",
  a_compor_design:        "text-emerald-600",
  a_aguardar_aprovacao:   "text-teal-600",
  a_ser_emoldurado:       "text-cyan-600",
  emoldurado:             "text-sky-600",
  a_ser_fotografado:      "text-blue-600",
  quadro_pronto:          "text-indigo-600",
  quadro_enviado:         "text-violet-600",
  quadro_recebido:        "text-fuchsia-600",
