...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 px-4 pb-[max(env(safe-area-inset-bottom),1rem)] sm:bottom-4 sm:left-auto sm:right-4 sm:px-0">
      <div className="mx-auto max-w-sm rounded-2xl border border-cream-200 bg-surface shadow-lg sm:max-w-xs">
        <div className="flex items-start gap-3 p-3.5">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-cream-50 to-cream-200 text-cocoa-900">
          ...
          <div className="min-w-0 flex-1">
            ...
            {deferredPrompt ? (
              ...
              <p className="mt-0.5 flex flex-wrap items-center gap-1 text-xs leading-relaxed text-cocoa-700">
                Toca em
            ...
            {deferredPrompt && (
              <button
                ...
                className="mt-2.5 inline-flex h-8 items-center gap-1.5 rounded-lg bg-btn-primary px-3 text-xs font-medium text-btn-primary-fg hover:bg-btn-primary-hover transition-colors"
              >
          ...
          <button
            ...
            className="-mr-1 -mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-cocoa-700 hover:bg-cream-50 hover:text-cocoa-900 dark:text-[#A8956C]"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
