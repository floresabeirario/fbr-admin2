  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          // Mobile: w-full em side=left/right para o formulário não ficar espremido em 75% do viewport.
// Desktop (sm:+): mantém w-3/4 + sm:max-w-sm (override do caller via sm:max-w-xl continua a funcionar).
